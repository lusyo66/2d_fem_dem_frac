...
////////////////////////////////////////////////////////////////////////////////////////////////////
// main program
void main_ellip3d(float disp_top, float shear_angle, int num_runs, int num_threads, std::string dirName, double dt, demInput demParams)
{
...
//	    "comp_debug");
    ...
    A.simpleShear(int(dt/dem::TIMESTEP),	// the timestep used in FEM and DEM may be different, so control the total_steps to keep the time the same
                         disp_top,		// displacement of top boundary, positive downward
                         shear_angle,  		// displacement of bottom boundary, positive upward
